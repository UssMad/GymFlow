## 1. GFRS-39 - Subscription data model

- [x] 1.1 Add subscription plan and member subscription migrations.
- [x] 1.2 Add Eloquent models, relationships, and effective-status resolution.
- [x] 1.3 Add Pest coverage for history and expired status resolution.
