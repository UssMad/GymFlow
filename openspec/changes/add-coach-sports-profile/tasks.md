## 1. GFRS-37 - Sports profile access

- [x] 1.1 Reuse the MLD-aligned `sport_profiles` entity and expose its API resource.
- [x] 1.2 Add an assigned-coach-only endpoint to retrieve a member sports profile.
- [x] 1.3 Add Pest coverage for authentication and coach-member ownership.
