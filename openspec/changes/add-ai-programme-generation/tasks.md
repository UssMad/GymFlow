## 1. GFRS-41 - Queue AI generation from a profile

- [x] 1.1 Install and configure the official Laravel AI SDK.
- [x] 1.2 Add the structured workout-programme agent and requesting-coach audit field.
- [x] 1.3 Add the assigned-coach-only endpoint that records context and queues a generation.
- [x] 1.4 Add request and authorization tests.
